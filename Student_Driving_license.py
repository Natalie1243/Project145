...
license_id = ""
ID = Label(root, text = license_id)
ID.pack()
license_name = ""
name = Label(root, text = license_name)
name.pack()
license_dob = ""
dob = Label(root, text = license_dob)
dob.pack()
license_pin = ""
pin = Label(root, text = license_pin)
pin.pack()
license_address = ""
address = Label(root, text = license_address)
address.pack()
vehicle_holders = ""
vehicle_holders = Label(root, text = vehicle_holders)
vehicle_holders.pack()
...
def License():
    ...
    print(type(address))
    vehicle_holders = "Two Four"
    print(type(vehicle_holders))
    
    
    show_license = ""
    show_license = Button(root, text= "Show my Driving License", command= License)
    show_license.pack()
